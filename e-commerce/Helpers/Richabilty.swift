...
//  internProject
//
//  Created by Alperen Selçuk on 1.09.2021.
//  Copyright © 2021 Alperen Selçuk. All rights reserved.
//


//internet baglantisini kontrol edecek..
...
public class Reachabilty {
    ...
    class func HasConnection() -> Bool {
        ...
        let defaultRoutReachabilty = withUnsafePointer(to: &zeroAddress, {
        ...
        if SCNetworkReachabilityGetFlags(defaultRoutReachabilty!, &flags) == false {
            return false
        }
